...
7 is the single most likely number to be a sum, with 6,8 and 5,9\dots\ increasingly less likely.
...
With four dice, it's possible to roll all even or all odd numbers, and not have an odd sum at all, but it's not possible to avoid an even sum.

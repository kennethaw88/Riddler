...
Within the range 1--$n$ it will always take $k-1$ clicks to get to 1.
Outside that range, the probability of randomly clicking into the range is $n/100$, so the average numbers of clicks to get there is $100/n$.

...
If both A and B are moving clockwise ($\omega_{A}$ and $\omega_{B}$ are negative), then the first solution for $t$ after 0 is (approximately)
\fcolorbox{red}{white}{\bf 1.6336 years}\,.
If A is moving clockwise and B is moving counterclockwise ($\omega_{A}$ is negative and $\omega_{B}$ is positive), then the first solution is
\fcolorbox{red}{white}{\bf 5.3061 years}\,.
If A is moving counterclockwise and B is moving clockwise ($\omega_{A}$ is positive and $\omega_{B}$ is negative), then the first solution is
\fcolorbox{red}{white}{\bf 1.5996 years}\,.
Finally, if both A and B are moving counterclockwise ($\omega_{A}$ and $\omega_{B}$ are positive), then the first solution is

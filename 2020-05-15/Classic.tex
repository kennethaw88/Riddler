...
\fcolorbox{red}{white}{disadvantage-of-advantage}
with an average roll of (approximately)
\fcolorbox{red}{white}{11.167}\,.
...
\fcolorbox{red}{white}{use any for at least 1, use DOA for at least 2--13, and use a single roll for 14--20}\,.
